 ...
 */
public protocol SelectionSorterWeightFactory<Solution_, T> {

    associatedtype Solution_
    associatedtype T
    associatedtype Comparable_ : SPComparable
     ...
     */
    func createSorterWeight(solution: Solution_, selection: T) -> Comparable_
